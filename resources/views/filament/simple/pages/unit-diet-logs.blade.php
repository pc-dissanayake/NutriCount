                            ...
                            @foreach ($logs as $log)
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-800">
                                    ...
                                    <td class="border border-gray-300 dark:border-gray-600 px-4 py-2 text-gray-900 dark:text-gray-100">
                                        ...
                                        @elseif($log->description === 'updated' && $log->properties && isset($log->properties['attributes']['amount']) && isset($log->properties['old']['amount']))
                                            <div class="text-sm">
                                        ...
                                        @elseif($log->description === 'deleted' && $log->properties && isset($log->properties['old']['amount']))
